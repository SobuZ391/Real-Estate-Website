    ...
    return (
        ...
        <Helmet>
            ...
            {user ? (
                ...
                <div>
                <div className='border-x-2 rounded-xl '><div className="flex glass   flex-col mx-auto justify-center  max-w-xl my-4 p-6 shadow-xl rounded-xl sm:px-12 dark:bg-gray-50 dark:text-gray-800">
                <div className="profile-image mx-auto">
                                ...
                                </div><div className="space-y-4 text-center divide-y dark:divide-gray-300">
		<div className="my-2 space-y-1">
			<h2 className="text-xl font-semibold sm:text-2xl">Name:{nameInput}</h2>
